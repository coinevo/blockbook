...
func Test_GetAddrDescFromAddress_Mainnet(t *testing.T) {
	...
	tests := []struct {
		...
		{
			name:    "P2PKH1",
			args:    args{address: "1LmFDuDc454a44NdiSdqVY5Zx44sdNDFPH"},
	...
	parser := NewEvoParser(GetChainParams("main"), &btc.Configuration{})
...
func Test_GetAddressesFromAddrDesc(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:    []string{"1LmFDuDc454a44NdiSdqVY5Zx44sdNDFPH"},
			want2:   true,
			wantErr: false,
		},
		{
